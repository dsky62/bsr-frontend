    ...
    <div style={styles.page}>
      ...
      <section style={styles.socialBar}>
        ...
        <div style={styles.socialIcons}>
          <a href="https://www.instagram.com/dombrooks" target="_blank" rel="noopener noreferrer" style={styles.socialPill} onMouseEnter={hoverSocialIn} onMouseLeave={hoverSocialOut}>
            📸 Instagram
          </a>
          <a href="https://www.tiktok.com/@dombrooks" target="_blank" rel="noopener noreferrer" style={styles.socialPill} onMouseEnter={hoverSocialIn} onMouseLeave={hoverSocialOut}>
            🎵 TikTok
          </a>
          <a href="https://www.youtube.com/@dombrooks" target="_blank" rel="noopener noreferrer" style={styles.socialPill} onMouseEnter={hoverSocialIn} onMouseLeave={hoverSocialOut}>
            ▶️ YouTube
          </a>
          <a href="https://x.com/reportbrooks" target="_blank" rel="noopener noreferrer" style={styles.socialPill} onMouseEnter={hoverSocialIn} onMouseLeave={hoverSocialOut}>
            𝕏 Twitter
          </a>
        </div>
      </section>
