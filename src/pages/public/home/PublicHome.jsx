    ...
    <div style={styles.page}>
      ...
      <section style={styles.reelSection}>
        ...
        <div style={styles.reelRow}>
          <div 
            ...
            onClick={() => navigate('/public/trending/top-guards-pnw')}
          ...
          <div 
            style={styles.reelCard}
            onClick={() => navigate('/public/trending/showcase-standouts')}
            onMouseEnter={hoverTrendingIn}
            onMouseLeave={hoverTrendingOut}
          >
          ...
          <div 
            style={styles.reelCard}
            onClick={() => navigate('/public/trending/freshmen-to-watch')}
            onMouseEnter={hoverTrendingIn}
            onMouseLeave={hoverTrendingOut}
          >
      ...
      <section style={styles.trendingStrip}>
        ...
        <div style={styles.trendingItems}>
          ...
          <span 
            style={{...styles.trendingItem, cursor: 'pointer'}}
            onClick={() => navigate('/public/trending/updated-class-rankings')}
          >
      ...
      <section style={styles.socialBar}>
        ...
        <div style={styles.socialIcons}>
          <a 
            href="https://www.instagram.com/dombrooks" 
            target="_blank" 
          ...
          <a 
            href="https://www.tiktok.com/@dombrooks" 
            target="_blank" 
            rel="noopener noreferrer"
            style={styles.socialPill}
            onMouseEnter={hoverSocialIn}
          ...
          <a 
            href="https://www.youtube.com/@dombrooks" 
            target="_blank" 
            rel="noopener noreferrer"
            style={styles.socialPill}
            onMouseEnter={hoverSocialIn}
